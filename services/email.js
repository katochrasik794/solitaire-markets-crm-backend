...
// Helper function to get logo URL - prefers base64 for email compatibility
export const getLogoUrl = () => {
  // If LOGO_URL is explicitly set, use it
  if (process.env.LOGO_URL) {
    return process.env.LOGO_URL;
  }
  // Otherwise use base64 embedded logo for maximum email client compatibility
  return LOGO_SVG_BASE64;
};
