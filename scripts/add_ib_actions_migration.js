/**
 * Script to add new IB actions to unified_actions table without truncating existing data
 * Run with: node scripts/add_ib_actions_migration.js
 */
...
async function runMigration() {
    try {
        ...
        const sqlFile = join(__dirname, '../database/add_ib_actions_only.sql');
        const sql = readFileSync(sqlFile, 'utf8');

        console.log('📝 Adding new IB actions to unified_actions...');
        ...
        console.log(`✅ Found ${result.rows.length} IB actions in unified_actions:`);
